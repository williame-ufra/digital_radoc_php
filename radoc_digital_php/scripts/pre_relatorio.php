    ...
    <div class="container p-5">
        <form method="post" action="?rota=pre_relatorio_submit">
            ...
            <div class="mb-3">
                ...
                Código do docente: <input class="form-control" type="text" placeholder="Digite seu código" name="codigo" required>
                ...
                Código da aula: <input class="form-control" type="text" placeholder="Digite o código da aula" name="codigo1" required>

                Nome da disciplina: <input class="form-control" type="text" placeholder="Digite o nome da disciplina" name="ndisciplina" required>

                Turma teórica: <input class="form-control" type="text" placeholder="Digite a turma teórica" name="turteorica" required>

                Turma prática: <input class="form-control" type="text" placeholder="Digite a turma prática" name="turpratica" required>
                ...
                Docentes: <input class="form-control" type="text" placeholder="Digite o nome do docente" name="docentes" required>

                Docentes ch: <input class="form-control" type="text" placeholder="Digite o ch do docente" name="docentesch" required>
